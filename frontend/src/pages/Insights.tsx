...
const METRICS = [
  { key: 'views', label: 'بازدید', note: 'هر بار که دفترچه یا کارتِ کسی باز شده' },
  { key: 'searches', label: 'جستجو', note: 'بازدیدهایی که با یک عبارتِ جستجو انجام شده' },
    ...
    <div className="relative min-h-dvh bg-[rgb(var(--canvas))]">
      ...
      <header ref={headRef} className="relative z-10">
        ...
        <p className="mx-auto mt-4 w-full max-w-6xl px-5 text-[12.5px] leading-relaxed text-ink-500 sm:px-8">
          ...
          که اینجا می‌بینید، ردش در تبِ «تغییرات» هم هست.
        </p>
        ...
        {data && totals && previous && (
          <>
            ...
            <p className="mt-8 text-[11.5px] leading-relaxed text-ink-400">
              ...
              {' · '}بازدیدهای پشتِ هم از یک حساب در یک ربع‌ساعت، در دفتر یک‌جا شمرده می‌شوند.
            </p>
          </>
        )}
      </main>
